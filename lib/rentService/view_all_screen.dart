        ...
        builder:(context, snapshot) {
          ...
          return ListView.builder(
            ...
            return GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => FullRentScreen(url: snapshot.data.docs[index]['url'], machinename: snapshot.data.docs[index]['name'], phone: snapshot.data.docs[index]['phone'], address: snapshot.data.docs[index]['address'], day: snapshot.data.docs[index]['day'],
                      Description: snapshot.data.docs[index]['description'], price: snapshot.data.docs[index]['price'], sellername: snapshot.data.docs[index]['name']),));
                },
                child: Container(
